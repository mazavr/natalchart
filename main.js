(function ($) {
  ...
  function natalChart(container, options) {
    var CENTER = {
      X: 300,
      Y: 300
    };
...
//-----------------
    ...
    var createHomeLine = createLine(RADIUS.home1, RADIUS.home2, CENTER.X, CENTER.Y, {
      "stroke": "blue",
      "stroke-width": 3
    });
...
//-----------------
    ...
    function createArcSector(r1, r2, cx, cy, params, z) {
    ...
    var createZodiacArcSector = createArcSector(RADIUS.zodiac1, RADIUS.zodiac2, CENTER.X, CENTER.Y, {
      stroke: 'black',
      'stroke-width': 1,
      fill: 'none'
    });
...
//-----------------
  ...
  $.fn.natalChart = function (options) {
    options = $.extend({}, options);

    return this.each(function () {
      (new natalChart(this, options));
    });
  };
})(jQuery);
